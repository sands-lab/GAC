...
The problem is pervasive: ASVD~\cite{asvd} produces 95\% misaligned dimensions, and even LLM-Pruner~\cite{llmpruner}---whose pruning granularity is relatively coarse---still leaves 17\% of weights misaligned (Table~\ref{tab:main_results}).
